...
namespace A2_HTML5_Biz_App_New.Controllers
{
    public class CustomerInfoesAPIController : ApiController
    {
        ...
        // DELETE: api/CustomerInfoesAPI/5
        [ResponseType(typeof(CustomerInfo))]
